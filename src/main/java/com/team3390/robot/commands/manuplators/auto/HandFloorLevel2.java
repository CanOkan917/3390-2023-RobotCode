...
public class HandFloorLevel2 extends SequentialCommandGroup {
  /** Creates a new Hand3rdLevel2. */
  public HandFloorLevel2(ManuplatorSubsystem ms) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new ParallelDeadlineGroup(
        new WaitCommand(2),
        new ManuplatorMasterControl(ms, () -> 0.85, () -> 0.0)  
      )
    );
  }
}
